...
export const JSONFromService = { "edges": [{ "src_node_id": 100, "src_output_idx": 0, "dst_node_id": 101, "dst_input_idx": 0, "id": 10 }], "nodes": [{ levels: [1], "pos_x": 323.50000000000034, "pos_y": 117.00000000000011, "name": "服务端拿取的数据", "iconClassName": "el-icon-collection-tag", "form": { "details": "普通节点的内容balabala", "createTime": "Wed Apr 29 2020" }, "id": 100, "in_ports": [0], "out_ports": [0] }, { levels: [2, 3], "pos_x": 598.75000000000023, "pos_y": 271.0000000000002, "name": "普通节点", "iconClassName": "el-icon-collection-tag", "form": { "details": "普通节点的内容balabala", "createTime": "Wed Apr 29 2020" }, "id": 101, "in_ports": [0], "out_ports": [0] }] }
